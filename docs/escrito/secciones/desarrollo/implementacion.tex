...
a través del cual se agrega un ticket a la lista de tickets del restaurante. Es 
importante mencionar que no se agregó directamente un método para ``agregar 
